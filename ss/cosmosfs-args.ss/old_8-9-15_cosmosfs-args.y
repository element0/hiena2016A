...
commandname		:	FILEPATH
				{   payload->put( payload->data, "commandname", $1,
			...
			;
source			:	FILEPATH
				{   payload->put( payload->data, "source", $1,
					@1.first_line, @1.first_column,
					@1.last_line,  @1.last_column);
				    free($1);
				}
			|	source FILEPATH
				{   payload->put( payload->data, "source", $2,
...
fuseargs		:	fusearg
			...
			;
fusearg			:	FUSEARG
				{   payload->put( payload->data, "fusearg", $1,
					@1.first_line, @1.first_column,
					@1.last_line,  @1.last_column);
				    free($1); }
			;
fuseopts		:	FUSEARGO FUSEOPT
				{   payload->put( payload->data, "fusearg-o", $1, 
					@1.first_line, @1.first_column,
					@1.last_line,  @1.last_column);
				    free($1);
				    payload->put( payload->data, "fuseopt", $2, 
					@2.first_line, @2.first_column,
					@2.last_line,  @2.last_column);
				    free($2);
				}
			;
mountpoint		:	FILEPATH
				{   payload->put( payload->data, "mountpoint", $1,
					@1.first_line, @1.first_column,
					@1.last_line,  @1.last_column);
				    free($1);
				}
