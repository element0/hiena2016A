...
#define YYSTYPE         RQLSTYPE
/* Substitute the variable and function names.  */
#define yyparse         rqlparse
#define yylex           rqllex
#define yyerror         rqlerror
#define yydebug         rqldebug
#define yynerrs         rqlnerrs
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined RQLSTYPE_IS_TRIVIAL && RQLSTYPE_IS_TRIVIAL)))
...
{
       0,    42,    42,    49,    49,    53,    57,    66,    73,    81,
      82,    86,    92,   100,   112,   118,   124,   125,   126,   129,
     135,   141,   146,   150,   154,   160,   164
};
#endif

#if RQLDEBUG || YYERROR_VERBOSE || 0
/* YYTNAME[SYMBOL-NUM] -- String name of the symbol SYMBOL-NUM.
   First, the terminals, then, starting at YYNTOKENS, nonterminals.  */
static const char *const yytname[] =
{
  "$end", "error", "$undefined", "END", "EOL", "SELECT", "ALL", "FROM",
  "WHERE", "IS", "NOT", "LIKE", "SEMICOLON", "COMMA", "STAR",
  "STRING_LITERAL", "IDENTIFIER", "EXPR_BINARY_IS", "EXPR_COLUMN",
  "TAB_SRC_CHILD", "TAB_SRC_PROP", "TAB_AXPA_CHILD", "TAB_AXPA_PROP",
  "TAB_SEL_CHILD", "TAB_SEL_PROP", "$accept", "sql", "stmt_list",
  "statement", "select_stmt", "result_expr_list", "result_column_list",
  "result_column", "from_clause", "table_or_subquery_list", "where_clause",
  "expr", "literal_value", "column_expr", "binary_expr", "all_or_distinct", YY_NULLPTR
};
#endif
...
{
      -1,     9,    19,     8,   -25,    -4,   -25,    13,     0,   -25,
     -25,   -25,   -25,     5,    14,   -25,   -25,    10,   -25,   -25,
     -25,     2,   -25,     0,   -25,   -25,    -8,   -25,   -25,   -25,
     -25,   -10,    15,     2,     2,    -8,     2,    -8,    -8,    -8
};
...
{
       0,    25,     0,     0,     3,     0,    26,     0,     0,     1,
       2,     4,     5,     0,     7,    11,    12,     8,     9,    14,
      13,     0,     6,     0,    19,    20,    15,    16,    18,    17,
      10,     0,     0,     0,     0,    21,     0,    23,    22,    24
};
...
{
      34,    31,    32,    33,     1,    24,    25,    35,    12,    37,
      38,    10,    39,     1,    15,     6,    16,    24,    25,     9,
      13,    19,    21,    23,    11,     0,    36,    30
};

static const yytype_int8 yycheck[] =
{
      10,     9,    10,    11,     5,    15,    16,    31,    12,    33,
      34,     3,    36,     5,    14,     6,    16,    15,    16,     0,
       7,    16,     8,    13,     3,    -1,    11,    23
};
...
{
       0,     5,    26,    27,    28,    29,     6,    30,    40,     0,
       3,    28,    12,     7,    33,    14,    16,    31,    32,    16,
      34,     8,    35,    13,    15,    16,    36,    37,    38,    39,
      32,     9,    10,    11,    10,    36,    11,    36,    36,    36
};
...
#line 101 "rql.y" /* yacc.c:1646  */
    {
			...
			from(TAB_SEL_CHILD);
		    }else if(strcmp((yyvsp[0].str), "selection_prop")==0) {
			from(TAB_SEL_PROP);
		    }
